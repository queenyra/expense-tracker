...
const AddTransaction=(props)=>{
    ...
    const getTanggal=()=>{
        ...
        //perlu tambahan padStart()agar tanggal tampil 2 digit dengan awa l0
        ...
        <section id="add-transaction">
            <div className="container py-5">
                ...
                <form onSubmit={handleFormSubmit}>
                    ...
                    <p><small>*Jika diisi angka negatif,akan tercatat dipengeluaran</small></p>
